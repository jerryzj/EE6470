...
extern "C" void fuse_conv2d_relu_2( void* args,  void* arg_type_ids, int num_args) {
  ...
  (((TVMArray*)stack_array)[0].shape) = ((int64_t*)stack_shape + 0);
  (((TVMArray*)stack_array)[0].strides) = ((int64_t*)stack_shape + 3);
  ...
  (((TVMArray*)stack_array)[1].shape) = ((int64_t*)stack_shape + 6);
  (((TVMArray*)stack_array)[1].strides) = ((int64_t*)stack_shape + 10);
  ...
  (((TVMArray*)stack_array)[2].shape) = ((int64_t*)stack_shape + 14);
  (((TVMArray*)stack_array)[2].strides) = ((int64_t*)stack_shape + 17);
  ...
  (((TVMArray*)stack_array)[1].shape) = ((int64_t*)stack_shape + 6);
  (((TVMArray*)stack_array)[1].strides) = ((int64_t*)stack_shape + 9);
