const int64_t data_shape[4] = {1,1,14,14};
...
float* relu0 = nullptr;
const int64_t relu0_shape[4] = {1,4,12,12};
...
const int64_t max_pool2d0_shape[4] = {1,4,6,6};
...
const int64_t net0_conv1_weight_shape[4] = {8,4,3,3};
DLTensor net0_conv1_weight_tensor = {
	(void*)net0_conv1_weight/*data*/, 
	DLContext({kDLFirmware, 0 /*device_id*/}), 
	4/*ndim*/, 
	DLDataType({2, 32, 1}), /*float code*/
	(int64_t*)net0_conv1_weight_shape /*shape*/, 
	nullptr /*strides*/, 
	0 /*byte_offset*/, 
};
const int64_t net0_conv1_bias_shape[1] = {8};
DLTensor net0_conv1_bias_tensor = {
	(void*)net0_conv1_bias/*data*/, 
	DLContext({kDLFirmware, 0 /*device_id*/}), 
	1/*ndim*/, 
	DLDataType({2, 32, 1}), /*float code*/
	(int64_t*)net0_conv1_bias_shape /*shape*/, 
	nullptr /*strides*/, 
	0 /*byte_offset*/, 
};
// tensor: 7 : relu1
...
float* relu1 = nullptr;
const int64_t relu1_shape[4] = {1,8,4,4};
...
const int64_t max_pool2d1_shape[4] = {1,8,2,2};
DLTensor max_pool2d1_tensor = {
	(void*)max_pool2d1/*data*/, 
	DLContext({kDLFirmware, 0 /*device_id*/}), 
	4/*ndim*/, 
	DLDataType({2, 32, 1}), /*float code*/
	(int64_t*)max_pool2d1_shape /*shape*/, 
	nullptr /*strides*/, 
	0 /*byte_offset*/, 
};
// tensor: 9 : flatten0
...
const int64_t flatten0_shape[2] = {1,32};
...
const int64_t net0_dense0_weight_shape[2] = {10,32};
DLTensor net0_dense0_weight_tensor = {
	(void*)net0_dense0_weight/*data*/, 
	DLContext({kDLFirmware, 0 /*device_id*/}), 
	2/*ndim*/, 
	DLDataType({2, 32, 1}), /*float code*/
	(int64_t*)net0_dense0_weight_shape /*shape*/, 
	nullptr /*strides*/, 
	0 /*byte_offset*/, 
};
const int64_t net0_dense0_bias_shape[1] = {10};
DLTensor net0_dense0_bias_tensor = {
	(void*)net0_dense0_bias/*data*/, 
	DLContext({kDLFirmware, 0 /*device_id*/}), 
	1/*ndim*/, 
	DLDataType({2, 32, 1}), /*float code*/
	(int64_t*)net0_dense0_bias_shape /*shape*/, 
	nullptr /*strides*/, 
	0 /*byte_offset*/, 
};
// tensor: 12 : dense0
...
const int64_t dense0_shape[2] = {1,10};
